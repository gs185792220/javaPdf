...
//              new int[1]).toDispatch();//打开word文件 
    ...
    public static void main(String[] args)throws Exception{
        ...
        word.openDocument("d:/word/test.docx");

//        word.setHeaderContent("*****************88设置页眉内容11111111111111111!");
        
        //表格1 客户信息
//        word.putTxtToCell( 1, 1, 1,"姓名:");
        word.putTxtToCell( 1, 1, 2,"test");
//        word.putTxtToCell( 1, 1, 3,"样本编号:");
        word.putTxtToCell( 1, 1, 4,"15132");

//        word.putTxtToCell( 1, 2, 1,"性别:");
        word.putTxtToCell( 1, 2, 2,"男");
//        word.putTxtToCell( 1, 2, 3,"年龄:");      
        word.putTxtToCell( 1, 2, 4,"22");
        
//      word.putTxtToCell( 1, 3, 1,"联系方式:");       
        word.putTxtToCell( 1, 3, 2,"12345678901");
//      word.putTxtToCell( 1, 3, 3,"检测项目:");       
        word.putTxtToCell( 1, 3, 4,"项目1");       
        
//      word.putTxtToCell( 1, 4, 1,"送检医生:");       
        word.putTxtToCell( 1, 4, 2,"小王");
//      word.putTxtToCell( 1, 4, 3,"送检单位:");       
        word.putTxtToCell( 1, 4, 4,"医院1");         
        

//      word.putTxtToCell( 1, 5, 1,"病理诊断:");       
        word.putTxtToCell( 1, 5, 2,"小细胞");
//      word.putTxtToCell( 1, 5, 3,"样本类型:");       
        word.putTxtToCell( 1, 5, 4,"新鲜组织");  

//      word.putTxtToCell( 1, 5, 1,"送检时间:");       
        word.putTxtToCell( 1, 5, 2,"2018-4-25");
//      word.putTxtToCell( 1, 5, 3,"报告时间:");       
        word.putTxtToCell( 1, 5, 4,"2018-4-25");   
        ...
        for (int i = 1; i <= num2; i++) {
        	if (i!=num2) {
        		word.addLastTableRow(2);
			}
        	word.putTxtToCell( 2, i+1, 1,"EFD"+i);
    	    word.putTxtToCell( 2, i+1, 2,"test"+i);
    	    word.putTxtToCell( 2, i+1, 3,"2.33%"+i);
    	    word.putTxtToCell( 2, i+1, 4,"点突变1"+i);
    	    word.putTxtToCell( 2, i+1, 5,"药物1"+i);
    	    
		}
        word.setTableCellSelected(2,2,1);
        word.setFont(false, false, false, "45136", "10", "微软雅黑");
//        word.addTableRow(2,2);
...
//	    word.autoFitTable();
        ...
        for (int i = 1; i <= num3; i++) {
        	if (i!=num3) {
        		word.addLastTableRow(3);
			}
        	word.putTxtToCell( 3, i+1, 1,"肿瘤突变11"+i);
    	    word.putTxtToCell( 3, i+1, 2,"高"+i);
		}

        
        word.save("d:/word/test_word.docx");
